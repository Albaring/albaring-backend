...
import static com.albaring.core.auth.step.AuthSteps.로그아웃_요청;
import static com.albaring.core.auth.step.AuthSteps.소셜_로그인_요청;
import static com.albaring.core.auth.step.AuthSteps.실패하는_로그아웃_요청;
import static com.albaring.core.auth.step.AuthSteps.실패하는_소셜_로그인_요청;
